    ...
    public class ProductInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<ProductContext>
    {
        ...
        protected override void Seed(ProductContext context)
        {
            var product = new List<product>
            {
                ...
                new product {pName="Batton Nunchaku", Descrition="Batton Nunchaku. Two weapons in one. Twist and lock together to make a 16, Batton - un-twist and use as metal nunchaku.", Quantity="1",price= "15.99", EnrollmentDate=DateTime.Parse("2015-09-10")},
                ...
                new product {pName="Adidas WTF Forearm Protectors", Descrition="WTF Approved Made PU, Two all around elastic straps with easy velcro closing tight fitting, CE Approved.", Quantity="2",price= "9.99",EnrollmentDate=DateTime.Parse("2016-10-20")},
